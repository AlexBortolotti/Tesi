...
[t_lock,y_lock,t_short_lock] = model_HK(simulength_lock, susc, cont_mat_lock, agg_istat_pyr, tau, delta_E, prob_symp, gammaI, gammaA, initS_lock, initE_lock, initI_lock, initA_lock, initR_lock, firstDay_lock);
